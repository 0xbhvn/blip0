...
/**
 * PiMessageArrowLeftSolid icon from the solid style in communication category.
 */
interface PiMessageArrowLeftSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiMessageArrowLeftSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'message-arrow-left icon',
  ...props
}: PiMessageArrowLeftSolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
