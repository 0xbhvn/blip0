...
export default function PiChatPlusSolid({
  ...
  ...props
}: PiChatPlusSolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
