...
/**
 * PiAnnotationInformationSolid icon from the solid style in communication category.
 */
interface PiAnnotationInformationSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiAnnotationInformationSolid({
  size = 24,
  color,
  className,
