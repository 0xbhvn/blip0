...
/**
 * PiEnvelopePlusSolid icon from the solid style in communication category.
 */
interface PiEnvelopePlusSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiEnvelopePlusSolid({
  size = 24,
  color,
  className,
