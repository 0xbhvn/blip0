...
/**
 * PiMessagePlusSolid icon from the solid style in communication category.
 */
interface PiMessagePlusSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiMessagePlusSolid({
  size = 24,
  color,
  className,
