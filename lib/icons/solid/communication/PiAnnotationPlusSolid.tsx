...
/**
 * PiAnnotationPlusSolid icon from the solid style in communication category.
 */
interface PiAnnotationPlusSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiAnnotationPlusSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'annotation-plus icon',
  ...props
}: PiAnnotationPlusSolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
