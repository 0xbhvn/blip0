...
/**
 * PiContactsBookSolid icon from the solid style in communication category.
 */
interface PiContactsBookSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiContactsBookSolid({
  size = 24,
  color,
  className,
