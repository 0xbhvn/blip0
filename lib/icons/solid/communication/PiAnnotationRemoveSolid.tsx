...
/**
 * PiAnnotationRemoveSolid icon from the solid style in communication category.
 */
interface PiAnnotationRemoveSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiAnnotationRemoveSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'annotation-remove icon',
  ...props
}: PiAnnotationRemoveSolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
