...
/**
 * PiAnnotationDefaultSolid icon from the solid style in communication category.
 */
interface PiAnnotationDefaultSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiAnnotationDefaultSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'annotation-default icon',
  ...props
}: PiAnnotationDefaultSolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
