...
/**
 * PiMessageQuoteSolid icon from the solid style in communication category.
 */
interface PiMessageQuoteSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiMessageQuoteSolid({
  size = 24,
  color,
  className,
