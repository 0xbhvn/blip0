...
/**
 * PiChatCheckSolid icon from the solid style in communication category.
 */
interface PiChatCheckSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiChatCheckSolid({
  size = 24,
  color,
  className,
