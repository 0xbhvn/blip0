...
/**
 * PiChatDefaultSolid icon from the solid style in communication category.
 */
interface PiChatDefaultSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiChatDefaultSolid({
  size = 24,
  color,
  className,
