...
/**
 * PiMessageArrowRightSolid icon from the solid style in communication category.
 */
interface PiMessageArrowRightSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiMessageArrowRightSolid({
  size = 24,
  color,
  className,
