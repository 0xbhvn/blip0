...
/**
 * PiInboxOutgoingSolid icon from the solid style in communication category.
 */
interface PiInboxOutgoingSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiInboxOutgoingSolid({
  size = 24,
  color,
  className,
