...
/**
 * PiAnnotationExclamationSolid icon from the solid style in communication category.
 */
interface PiAnnotationExclamationSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiAnnotationExclamationSolid({
  size = 24,
  color,
  className,
