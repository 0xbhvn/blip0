...
export default function PiMapPinUserSolid({
  ...
  ...props
}: PiMapPinUserSolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
