...
/**
 * PiCameraRemoveSolid icon from the solid style in devices category.
 */
interface PiCameraRemoveSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCameraRemoveSolid({
  size = 24,
  color,
  className,
