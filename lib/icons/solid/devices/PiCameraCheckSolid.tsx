...
/**
 * PiCameraCheckSolid icon from the solid style in devices category.
 */
interface PiCameraCheckSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCameraCheckSolid({
  size = 24,
  color,
  className,
