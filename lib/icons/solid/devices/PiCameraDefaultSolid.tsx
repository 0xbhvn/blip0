...
/**
 * PiCameraDefaultSolid icon from the solid style in devices category.
 */
interface PiCameraDefaultSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCameraDefaultSolid({
  size = 24,
  color,
  className,
