...
/**
 * PiScreenUploadSolid icon from the solid style in devices category.
 */
interface PiScreenUploadSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiScreenUploadSolid({
  size = 24,
  color,
  className,
