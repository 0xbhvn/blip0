...
/**
 * PiBatteryTwoCellSolid icon from the solid style in devices category.
 */
interface PiBatteryTwoCellSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiBatteryTwoCellSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'battery-two-cell icon',
  ...props
}: PiBatteryTwoCellSolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
