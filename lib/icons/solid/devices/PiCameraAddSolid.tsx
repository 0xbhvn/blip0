...
/**
 * PiCameraAddSolid icon from the solid style in devices category.
 */
interface PiCameraAddSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCameraAddSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'camera-add icon',
  ...props
}: PiCameraAddSolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
