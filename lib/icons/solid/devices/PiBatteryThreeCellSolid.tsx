...
/**
 * PiBatteryThreeCellSolid icon from the solid style in devices category.
 */
interface PiBatteryThreeCellSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiBatteryThreeCellSolid({
  size = 24,
  color,
  className,
