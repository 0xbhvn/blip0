 ...
 */
interface PiBatteryOneCellSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiBatteryOneCellSolid({
  ...
  ...props
}: PiBatteryOneCellSolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
