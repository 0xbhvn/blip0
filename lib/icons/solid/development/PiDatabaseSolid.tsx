...
/**
 * PiDatabaseSolid icon from the solid style in development category.
 */
interface PiDatabaseSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiDatabaseSolid({
  size = 24,
  color,
  className,
