...
/**
 * PiBottleMilkSolid icon from the solid style in food category.
 */
interface PiBottleMilkSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiBottleMilkSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'bottle-milk icon',
  ...props
}: PiBottleMilkSolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
