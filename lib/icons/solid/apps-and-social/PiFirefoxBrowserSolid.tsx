...
/**
 * PiFirefoxBrowserSolid icon from the solid style in apps-&-social category.
 */
interface PiFirefoxBrowserSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFirefoxBrowserSolid({
  size = 24,
  color,
  className,
