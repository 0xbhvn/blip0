...
/**
 * PiSyringeInjectionSolid icon from the solid style in medical category.
 */
interface PiSyringeInjectionSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiSyringeInjectionSolid({
  size = 24,
  color,
  className,
