...
/**
 * PiMedicalThermometerSolid icon from the solid style in medical category.
 */
interface PiMedicalThermometerSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiMedicalThermometerSolid({
  size = 24,
  color,
  className,
