...
/**
 * PiFolderRemoveSolid icon from the solid style in files-&-folders category.
 */
interface PiFolderRemoveSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderRemoveSolid({
  size = 24,
  color,
  className,
