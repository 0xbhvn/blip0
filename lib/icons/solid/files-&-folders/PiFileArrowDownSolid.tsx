...
/**
 * PiFileArrowDownSolid icon from the solid style in files-&-folders category.
 */
interface PiFileArrowDownSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileArrowDownSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-arrow-down icon',
  ...props
}: PiFileArrowDownSolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
