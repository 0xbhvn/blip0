...
/**
 * PiArchiveCancelSolid icon from the solid style in files-&-folders category.
 */
interface PiArchiveCancelSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiArchiveCancelSolid({
  size = 24,
  color,
  className,
