...
/**
 * PiFolderDefaultSolid icon from the solid style in files-&-folders category.
 */
interface PiFolderDefaultSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderDefaultSolid({
  size = 24,
  color,
  className,
