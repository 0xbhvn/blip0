...
/**
 * PiFileCancelSolid icon from the solid style in files-&-folders category.
 */
interface PiFileCancelSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileCancelSolid({
  size = 24,
  color,
  className,
