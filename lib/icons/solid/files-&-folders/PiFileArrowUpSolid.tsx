...
/**
 * PiFileArrowUpSolid icon from the solid style in files-&-folders category.
 */
interface PiFileArrowUpSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileArrowUpSolid({
  size = 24,
  color,
  className,
