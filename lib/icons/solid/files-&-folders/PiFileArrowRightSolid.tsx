...
/**
 * PiFileArrowRightSolid icon from the solid style in files-&-folders category.
 */
interface PiFileArrowRightSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileArrowRightSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-arrow-right icon',
  ...props
}: PiFileArrowRightSolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
