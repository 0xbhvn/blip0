...
/**
 * PiClipboardTextSolid icon from the solid style in files-&-folders category.
 */
interface PiClipboardTextSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiClipboardTextSolid({
  size = 24,
  color,
  className,
