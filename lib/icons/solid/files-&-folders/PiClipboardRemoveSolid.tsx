...
/**
 * PiClipboardRemoveSolid icon from the solid style in files-&-folders category.
 */
interface PiClipboardRemoveSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiClipboardRemoveSolid({
  size = 24,
  color,
  className,
