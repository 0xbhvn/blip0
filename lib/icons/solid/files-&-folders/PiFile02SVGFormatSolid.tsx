...
/**
 * PiFile02SVGFormatSolid icon from the solid style in files-&-folders category.
 */
interface PiFile02SVGFormatSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFile02SVGFormatSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-02-svg-format icon',
  ...props
}: PiFile02SVGFormatSolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
