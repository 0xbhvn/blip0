...
/**
 * PiFolderArrowRightSolid icon from the solid style in files-&-folders category.
 */
interface PiFolderArrowRightSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderArrowRightSolid({
  size = 24,
  color,
  className,
