...
/**
 * PiFilePlusSolid icon from the solid style in files-&-folders category.
 */
interface PiFilePlusSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFilePlusSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-plus icon',
  ...props
}: PiFilePlusSolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
