...
/**
 * PiFileInformationSolid icon from the solid style in files-&-folders category.
 */
interface PiFileInformationSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileInformationSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-information icon',
  ...props
}: PiFileInformationSolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
