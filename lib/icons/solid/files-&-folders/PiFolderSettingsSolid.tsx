...
/**
 * PiFolderSettingsSolid icon from the solid style in files-&-folders category.
 */
interface PiFolderSettingsSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderSettingsSolid({
  size = 24,
  color,
  className,
