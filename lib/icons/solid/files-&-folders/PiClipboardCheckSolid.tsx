...
/**
 * PiClipboardCheckSolid icon from the solid style in files-&-folders category.
 */
interface PiClipboardCheckSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiClipboardCheckSolid({
  size = 24,
  color,
  className,
