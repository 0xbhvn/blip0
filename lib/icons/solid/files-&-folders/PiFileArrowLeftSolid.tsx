...
/**
 * PiFileArrowLeftSolid icon from the solid style in files-&-folders category.
 */
interface PiFileArrowLeftSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileArrowLeftSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-arrow-left icon',
  ...props
}: PiFileArrowLeftSolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
