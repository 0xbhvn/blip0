...
/**
 * PiFileRemoveSolid icon from the solid style in files-&-folders category.
 */
interface PiFileRemoveSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileRemoveSolid({
  size = 24,
  color,
  className,
