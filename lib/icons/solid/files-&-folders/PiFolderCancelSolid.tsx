...
/**
 * PiFolderCancelSolid icon from the solid style in files-&-folders category.
 */
interface PiFolderCancelSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderCancelSolid({
  size = 24,
  color,
  className,
