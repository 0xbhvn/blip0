...
/**
 * PiFileQuestionMarkSolid icon from the solid style in files-&-folders category.
 */
interface PiFileQuestionMarkSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileQuestionMarkSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-question-mark icon',
  ...props
}: PiFileQuestionMarkSolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
