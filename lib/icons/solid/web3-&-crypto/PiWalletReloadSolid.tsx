...
/**
 * PiWalletReloadSolid icon from the solid style in web3-&-crypto category.
 */
interface PiWalletReloadSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiWalletReloadSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'wallet-reload icon',
  ...props
}: PiWalletReloadSolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
