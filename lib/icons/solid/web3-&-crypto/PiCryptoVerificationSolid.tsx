...
/**
 * PiCryptoVerificationSolid icon from the solid style in web3-&-crypto category.
 */
interface PiCryptoVerificationSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCryptoVerificationSolid({
  size = 24,
  color,
  className,
