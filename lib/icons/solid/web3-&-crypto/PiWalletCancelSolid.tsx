...
/**
 * PiWalletCancelSolid icon from the solid style in web3-&-crypto category.
 */
interface PiWalletCancelSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiWalletCancelSolid({
  size = 24,
  color,
  className,
