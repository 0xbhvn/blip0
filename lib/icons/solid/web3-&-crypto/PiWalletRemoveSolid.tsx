...
/**
 * PiWalletRemoveSolid icon from the solid style in web3-&-crypto category.
 */
interface PiWalletRemoveSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiWalletRemoveSolid({
  size = 24,
  color,
  className,
