...
/**
 * PiWalletExclamationMarkSolid icon from the solid style in web3-&-crypto category.
 */
interface PiWalletExclamationMarkSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiWalletExclamationMarkSolid({
  size = 24,
  color,
  className,
