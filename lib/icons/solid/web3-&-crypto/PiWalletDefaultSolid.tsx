...
/**
 * PiWalletDefaultSolid icon from the solid style in web3-&-crypto category.
 */
interface PiWalletDefaultSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiWalletDefaultSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'wallet-default icon',
  ...props
}: PiWalletDefaultSolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
