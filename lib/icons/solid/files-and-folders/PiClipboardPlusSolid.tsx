...
/**
 * PiClipboardPlusSolid icon from the solid style in files-&-folders category.
 */
interface PiClipboardPlusSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiClipboardPlusSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'clipboard-plus icon',
  ...props
}: PiClipboardPlusSolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
