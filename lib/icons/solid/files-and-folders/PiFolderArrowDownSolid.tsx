...
/**
 * PiFolderArrowDownSolid icon from the solid style in files-&-folders category.
 */
interface PiFolderArrowDownSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderArrowDownSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'folder-arrow-down icon',
  ...props
}: PiFolderArrowDownSolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
