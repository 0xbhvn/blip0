...
/**
 * PiArchiveArrowDownSolid icon from the solid style in files-&-folders category.
 */
interface PiArchiveArrowDownSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiArchiveArrowDownSolid({
  size = 24,
  color,
  className,
