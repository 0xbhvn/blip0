...
/**
 * PiFolderPlusSolid icon from the solid style in files-&-folders category.
 */
interface PiFolderPlusSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderPlusSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'folder-plus icon',
  ...props
}: PiFolderPlusSolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
