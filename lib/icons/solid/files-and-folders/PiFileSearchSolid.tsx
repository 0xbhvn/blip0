...
/**
 * PiFileSearchSolid icon from the solid style in files-&-folders category.
 */
interface PiFileSearchSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileSearchSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-search icon',
  ...props
}: PiFileSearchSolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
