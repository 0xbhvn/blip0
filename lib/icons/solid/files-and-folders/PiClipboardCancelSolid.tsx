...
/**
 * PiClipboardCancelSolid icon from the solid style in files-&-folders category.
 */
interface PiClipboardCancelSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiClipboardCancelSolid({
  size = 24,
  color,
  className,
