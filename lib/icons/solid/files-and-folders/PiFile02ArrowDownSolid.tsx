...
/**
 * PiFile02ArrowDownSolid icon from the solid style in files-&-folders category.
 */
interface PiFile02ArrowDownSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFile02ArrowDownSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-02-arrow-down icon',
  ...props
}: PiFile02ArrowDownSolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
