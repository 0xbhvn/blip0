...
/**
 * PiFileCheckSolid icon from the solid style in files-&-folders category.
 */
interface PiFileCheckSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFileCheckSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-check icon',
  ...props
}: PiFileCheckSolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
