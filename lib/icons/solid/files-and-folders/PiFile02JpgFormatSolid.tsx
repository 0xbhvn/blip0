...
/**
 * PiFile02JpgFormatSolid icon from the solid style in files-&-folders category.
 */
interface PiFile02JpgFormatSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFile02JpgFormatSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'file-02-jpg-format icon',
  ...props
}: PiFile02JpgFormatSolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
