...
/**
 * PiFolderCheckSolid icon from the solid style in files-&-folders category.
 */
interface PiFolderCheckSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiFolderCheckSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'folder-check icon',
  ...props
}: PiFolderCheckSolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
