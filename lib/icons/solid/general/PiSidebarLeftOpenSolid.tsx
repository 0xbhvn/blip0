...
/**
 * PiSidebarLeftOpenSolid icon from the solid style in general category.
 */
interface PiSidebarLeftOpenSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiSidebarLeftOpenSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'sidebar-left-open icon',
  ...props
}: PiSidebarLeftOpenSolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
