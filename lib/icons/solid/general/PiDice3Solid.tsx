 ...
 */
interface PiDice3SolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiDice3Solid({
  ...
  ...props
}: PiDice3SolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
