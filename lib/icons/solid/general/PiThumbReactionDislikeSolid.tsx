...
/**
 * PiThumbReactionDislikeSolid icon from the solid style in general category.
 */
interface PiThumbReactionDislikeSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiThumbReactionDislikeSolid({
  size = 24,
  color,
  className,
