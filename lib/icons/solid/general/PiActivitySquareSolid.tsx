...
/**
 * PiActivitySquareSolid icon from the solid style in general category.
 */
interface PiActivitySquareSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiActivitySquareSolid({
  size = 24,
  color,
  className,
