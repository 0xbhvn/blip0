...
/**
 * PiPurseBagRemoveSolid icon from the solid style in general category.
 */
interface PiPurseBagRemoveSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPurseBagRemoveSolid({
  size = 24,
  color,
  className,
