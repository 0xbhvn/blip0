...
/**
 * PiSidebarMenuSolid icon from the solid style in general category.
 */
interface PiSidebarMenuSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiSidebarMenuSolid({
  size = 24,
  color,
  className,
