...
/**
 * PiLayoutGridTwoHorizontalSolid icon from the solid style in general category.
 */
interface PiLayoutGridTwoHorizontalSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiLayoutGridTwoHorizontalSolid({
  size = 24,
  color,
  className,
