...
/**
 * PiSidebarRightCloseSolid icon from the solid style in general category.
 */
interface PiSidebarRightCloseSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiSidebarRightCloseSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'sidebar-right-close icon',
  ...props
}: PiSidebarRightCloseSolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
