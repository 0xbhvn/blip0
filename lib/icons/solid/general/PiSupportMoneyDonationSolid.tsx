...
/**
 * PiSupportMoneyDonationSolid icon from the solid style in general category.
 */
interface PiSupportMoneyDonationSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiSupportMoneyDonationSolid({
  size = 24,
  color,
  className,
