...
/**
 * PiPluginAddonPuzzleSolid icon from the solid style in general category.
 */
interface PiPluginAddonPuzzleSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPluginAddonPuzzleSolid({
  size = 24,
  color,
  className,
