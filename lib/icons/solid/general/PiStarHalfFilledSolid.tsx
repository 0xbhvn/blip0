...
/**
 * PiStarHalfFilledSolid icon from the solid style in general category.
 */
interface PiStarHalfFilledSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiStarHalfFilledSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'star-half-filled icon',
  ...props
}: PiStarHalfFilledSolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
