...
/**
 * PiDice5Solid icon from the solid style in general category.
 */
interface PiDice5SolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiDice5Solid({
  size = 24,
  color,
  className,
  ariaLabel = 'dice-5 icon',
  ...props
}: PiDice5SolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
