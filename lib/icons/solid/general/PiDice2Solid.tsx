...
export default function PiDice2Solid({
  ...
  ...props
}: PiDice2SolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
