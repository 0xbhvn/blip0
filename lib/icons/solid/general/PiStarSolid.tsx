...
/**
 * PiStarSolid icon from the solid style in general category.
 */
interface PiStarSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiStarSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'star icon',
