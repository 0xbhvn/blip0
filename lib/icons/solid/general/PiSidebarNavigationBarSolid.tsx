...
/**
 * PiSidebarNavigationBarSolid icon from the solid style in general category.
 */
interface PiSidebarNavigationBarSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiSidebarNavigationBarSolid({
  size = 24,
  color,
  className,
