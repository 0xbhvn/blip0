...
/**
 * PiLayoutGridTwoVerticalSolid icon from the solid style in general category.
 */
interface PiLayoutGridTwoVerticalSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiLayoutGridTwoVerticalSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'layout-grid-two-vertical icon',
  ...props
}: PiLayoutGridTwoVerticalSolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
