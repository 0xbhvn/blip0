...
/**
 * PiPlaylistAddSolid icon from the solid style in media category.
 */
interface PiPlaylistAddSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPlaylistAddSolid({
  size = 24,
  color,
  className,
