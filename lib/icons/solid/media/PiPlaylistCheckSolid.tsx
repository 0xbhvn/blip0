...
/**
 * PiPlaylistCheckSolid icon from the solid style in media category.
 */
interface PiPlaylistCheckSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPlaylistCheckSolid({
  size = 24,
  color,
  className,
