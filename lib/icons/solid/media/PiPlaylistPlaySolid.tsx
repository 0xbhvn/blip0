...
/**
 * PiPlaylistPlaySolid icon from the solid style in media category.
 */
interface PiPlaylistPlaySolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPlaylistPlaySolid({
  size = 24,
  color,
  className,
