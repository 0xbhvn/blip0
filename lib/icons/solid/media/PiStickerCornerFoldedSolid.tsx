...
export default function PiStickerCornerFoldedSolid({
  ...
  ...props
}: PiStickerCornerFoldedSolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
