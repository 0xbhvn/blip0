...
/**
 * PiPlaylistSearchSolid icon from the solid style in media category.
 */
interface PiPlaylistSearchSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPlaylistSearchSolid({
  size = 24,
  color,
  className,
