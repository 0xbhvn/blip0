...
/**
 * PiPhotoImagePlusSolid icon from the solid style in media category.
 */
interface PiPhotoImagePlusSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiPhotoImagePlusSolid({
  size = 24,
  color,
  className,
