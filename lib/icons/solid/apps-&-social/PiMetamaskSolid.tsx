...
/**
 * PiMetamaskSolid icon from the solid style in apps-&-social category.
 */
interface PiMetamaskSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiMetamaskSolid({
  size = 24,
  color,
  className,
