...
/**
 * PiAlertTriangleSolid icon from the solid style in alerts category.
 */
interface PiAlertTriangleSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiAlertTriangleSolid({
  size = 24,
  color,
  className,
