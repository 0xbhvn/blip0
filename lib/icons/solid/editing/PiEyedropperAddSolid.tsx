...
/**
 * PiEyedropperAddSolid icon from the solid style in editing category.
 */
interface PiEyedropperAddSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiEyedropperAddSolid({
  size = 24,
  color,
  className,
