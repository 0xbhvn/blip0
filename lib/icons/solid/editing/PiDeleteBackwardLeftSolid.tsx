...
/**
 * PiDeleteBackwardLeftSolid icon from the solid style in editing category.
 */
interface PiDeleteBackwardLeftSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiDeleteBackwardLeftSolid({
  size = 24,
  color,
  className,
