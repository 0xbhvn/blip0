...
/**
 * PiCarFrontViewSolid icon from the solid style in automotive category.
 */
interface PiCarFrontViewSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCarFrontViewSolid({
  size = 24,
  color,
  className,
