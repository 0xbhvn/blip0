...
/**
 * PiTruckTrashSolid icon from the solid style in automotive category.
 */
interface PiTruckTrashSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiTruckTrashSolid({
  size = 24,
  color,
  className,
