...
/**
 * PiNftProfileUserSolid icon from the solid style in web3-&-crypto category.
 */
interface PiNftProfileUserSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiNftProfileUserSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'nft-profile-user icon',
  ...props
}: PiNftProfileUserSolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
