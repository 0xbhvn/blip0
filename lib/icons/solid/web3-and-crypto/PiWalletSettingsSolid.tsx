...
/**
 * PiWalletSettingsSolid icon from the solid style in web3-&-crypto category.
 */
interface PiWalletSettingsSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiWalletSettingsSolid({
  size = 24,
  color,
  className,
  ariaLabel = 'wallet-settings icon',
  ...props
}: PiWalletSettingsSolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
