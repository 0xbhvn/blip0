...
export default function PiCalendarInformationSolid({
  ...
  ...props
}: PiCalendarInformationSolidProps): React.ReactElement {
  return (
    <svg
      width={size}
      height={size}
