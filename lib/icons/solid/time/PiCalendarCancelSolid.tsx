...
/**
 * PiCalendarCancelSolid icon from the solid style in time category.
 */
interface PiCalendarCancelSolidProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
  color?: string;
  className?: string;
  ariaLabel?: string;
...
export default function PiCalendarCancelSolid({
  size = 24,
  color,
  className,
